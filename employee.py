...
class Employee :
    def __init__(self,root) :
        ...
        self.root.title("Employee CRUD system")
        ...
        lbl_title = Label(self.root,text="EMPLOYEE MANAGEMENT SYSTEM",
                          font=('times new roman',37,'bold'),fg='navy',bg='thistle3')
        lbl_title.place(x=0,y=0,width=1365,height=50)
        
        # logo
        img_logo = Image.open('./images/skills.png')
        ...
        #image frame
        img_frame = Frame(self.root,bd=2,relief='ridge',bg='DeepSkyBlue2')
        ...
        # main frame
        Main_frame=Frame(self.root,bd=2,relief='ridge',bg='thistle3')
        ...
        button_frame = Frame(upper_frame,bd=2,relief='ridge',bg='thistle3')
        ...
        # down frame
        down_frame = LabelFrame(Main_frame,bd=2,relief="ridge",bg='thistle3',
                                 text='Employee Management Information Table',
                                 font=('arial',12,'bold'),fg='navy')
        down_frame.place(x=10,y=230,width=1340,height=240)

        #searh Frame
        search_frame= LabelFrame(down_frame,text="Search Employee Information",relief='ridge',bd=2,font=('arial',11,'bold'),fg='navy', bg='thistle3')
    ...
    def AddData(self):
        ...
        conn = mysql.connector.connect(host="localhost",user="root",password="root1610",database="employeeschema")
        cursor = conn.cursor()
        try:
    ...
    def deleteData(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="root1610",database="employeeschema")
        cursor= conn.cursor()
